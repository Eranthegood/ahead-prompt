      ...
      >
        ...
        <g transform="translate(200, 150)">
          ...
          <g transform="translate(0, -45)">
            ...
            <text x="0" y="1" textAnchor="middle" fill="hsl(var(--foreground))" fontSize="6" fontWeight="bold">
              Prompt Queue
            </text>
