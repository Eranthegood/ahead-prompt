      ...
      <div className="absolute inset-0 flex items-center justify-center bg-transparent">
        <div className="relative w-full h-full scale-75 md:scale-85 lg:scale-95">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-8">
            ...
            >
              <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 flex items-center justify-center bg-primary/5 rounded-full">
                <Github className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-primary" />
              </div>
            </motion.div>
          ...
          {[
            ...
            { position: "lower-left", color: "hsl(var(--chart-1))", status: "Reviewing", icon: Code, x: "35%", y: "90%" },
            { position: "lower-right", color: "hsl(var(--chart-2))", status: "Monitoring", icon: Zap, x: "65%", y: "90%" }
          ].map((agent, index) => (
