...
export default function LandingPage() {
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      {/* Hero Section */}
      <main className="flex-1 flex items-center justify-center px-3 sm:px-6 pb-42 sm:pb-52 pt-36 sm:pt-42 md:pt-58">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
                  The first dedicated product development platform for Vibecoding. No more lost prompts in Google Docs; store, organize, and send your prompts from one place.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
               ...
               <div className="space-y-4">
                 ...
                 <div className="space-y-3">
                   ...
                   <div className="flex items-start gap-3">
                     ...
                     <div>
                       <span><strong>Organize and queue your prompts.</strong> Your prompts are organized in a Kanban view, breakdown by product, feature and priority to maximize your product development.</span>
                     </div>
                   </div>
                   <div className="flex items-start gap-3">
              ...
              <div className="flex items-center justify-center">
                <img src="/lovable-uploads/1759cd6a-21b8-4c30-98f6-0cbf4a99193e.png" alt="Ahead.love dashboard showing organized prompts in a dark interface with sidebar navigation and kanban-style layout" className="w-full max-w-4xl rounded-lg shadow-2xl border border-border" />
              </div>
          </div>
        </div>
      </section>
