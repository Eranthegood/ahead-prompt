...
export default function LandingPage() {
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Prompt Enhancer & CLEAR Framework Section */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold">
                Transform Ideas into <span className="text-primary">Perfect Prompts</span>
              </h2>
              
              <p className="text-xl text-muted-foreground">
                Stop writing mediocre prompts. Our AI-powered enhancer uses the CLEAR framework to transform your rough ideas into structured, effective prompts that get better results.
              </p>
                
              <div className="space-y-4">
                <h4 className="font-semibold text-lg">The CLEAR Framework:</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                    <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                    <div>
                      <span className="font-medium">Concise</span>
                      <p className="text-sm text-muted-foreground">150 words max</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                    <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Specific technologies</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                    <span className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Suggested MVP</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Measurable success criteria</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-muted/50 p-4 rounded-lg border-l-4 border-primary">
                <p className="text-sm text-muted-foreground">
                  <strong>Before:</strong> "Make a login page"<br/>
                  <strong>After:</strong> "Create a responsive login page with email/password fields, validation, loading states, and error handling. Include social login options and 'Remember me' checkbox. Use shadcn/ui components with proper accessibility."
                </p>
              </div>
                
              <Button size="lg" onClick={handleSignIn} className="px-8 py-6 text-lg font-medium group">
                {user ? "Try Prompt Enhancer" : "Enhance Your Prompts Free"}
                <Zap className="ml-2 h-5 w-5 transition-transform group-hover:scale-110" />
              </Button>
            </div>
            
            <div className="relative">
              <div className="bg-gradient-to-br from-primary/5 to-muted/20 rounded-2xl p-8 border">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="bg-background rounded-lg p-3 border">
                        <p className="text-sm text-muted-foreground">Raw idea:</p>
                        <p className="font-medium">"Build a todo app"</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center">
                    <div className="flex items-center gap-2 text-primary">
                      ...
                      <span className="text-sm font-medium">CLEAR Enhancement</span>
                      <Layers className="h-5 w-5" />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="bg-primary/5 border border-primary/20 rounded-lg p-3">
                        <p className="text-sm text-primary">Enhanced prompt:</p>
                        <p className="font-medium text-sm">
                          "Create a responsive todo app with task creation, editing, completion status, categories, and local storage persistence. Include drag-and-drop reordering, filters (all/active/completed), and dark mode support using React and Tailwind CSS."
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-primary rounded-full flex items-center justify-center animate-pulse" style={{ animationDelay: '0.5s' }}>
                <Zap className="h-3 w-3 text-primary-foreground" />
              </div>
            </div>
          </div>
