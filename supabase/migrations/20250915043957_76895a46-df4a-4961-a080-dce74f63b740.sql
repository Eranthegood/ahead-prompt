-- First, create a system profile and workspace for system prompts
...
INSERT INTO public.workspaces (
  ...
  '00000000-0000-0000-0000-000000000001',
  'System Templates',
  'System-wide prompt templates and resources',
  '00000000-0000-0000-0000-000000000001'
) ON CONFLICT (id) DO NOTHING;

-- Now insert the SaaS landing page prompt template
